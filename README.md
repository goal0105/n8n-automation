...
- [n8n-automation](#n8n-automation)
  ...
  - [Credential](#credential)
    - [RadioNews](#radionews)
    - [MistralOCR](#mistralocr)
    - [GoogleOCR](#googleocr)
    - [GroqTranslate](#groqtranslate)
    - [GroqTranscript](#groqtranscript)
    - [GenerateVideo](#generatevideo)

### Credential

- Groq : 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
...
- ShotStack : jag2pn7hng(Sandbox): T0mZ85JFMS87u5WYArIGSwQymiCArn511BWJjCjg, Mz1eil9p3p(Production) : 1GSC6MeVhQ2FClIfvCKqS4NA8TRVwr91M0VBT1qf
